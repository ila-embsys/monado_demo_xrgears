...
void
vulkan_texture::load_from_ktx(const ktx_uint8_t *bytes,
                              ktx_size_t size,
...
void
vulkan_texture::load_from_ktx(VkImage image,
...
void
vulkan_texture::create_image(VkFormat format)
{
...
void
vulkan_texture::upload(ktxTexture *tex, VkQueue copy_queue)
{
  ...
  _set_image_layout(copy_cmd, image, VK_IMAGE_LAYOUT_UNDEFINED,
  ...
  _set_image_layout(copy_cmd, image, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL,
...
void
vulkan_texture::upload_no_mem(ktxTexture *tex, VkQueue copy_queue)
{
  VkBufferCreateInfo bufferCreateInfo = {
    .sType = VK_STRUCTURE_TYPE_BUFFER_CREATE_INFO,
    .size = ktxTexture_GetSize(tex),
...
void
vulkan_texture::create_image_view(VkFormat format)
{
