...
_create_quad_swapchain(xr_quad* self, XrSession session, XrExtent2Di *extent)
{
  ...
  result =
    xrEnumerateSwapchainFormats(session, 0, &swapchainFormatCount, NULL);
...
void
xr_quad_init(xr_quad *self, XrSession session, XrSpace space,
             XrExtent2Di extent, XrPosef pose, XrExtent2Df size) {
